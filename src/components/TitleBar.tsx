  ...
  return (
    <div className="title-bar" data-tauri-drag-region>
      <div className="title-bar-left" data-tauri-drag-region>
        <span className="title-bar-project" title={rootPath} data-tauri-drag-region>{rootPath.split("/").pop() || "/"}</span>
        {activeFile && (
          <>
      ...
      <span className="title-bar-label" data-tauri-drag-region>ShadowIDE v0.84.0</span>
      {!isMobileDevice && (onOpenPlanengine || onOpenGamePanel || onOpenLiveView) && (
        <div className="title-bar-shortcuts">
          ...
          {onOpenPlanengine && (
            <button className="title-bar-shortcut title-bar-shortcut-plan" onClick={onOpenPlanengine} title={planTitle}>
              Plan
            </button>
          )}
          {onOpenGamePanel && (
